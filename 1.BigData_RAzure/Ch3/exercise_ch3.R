...
for(num in vec1){
  if(num > 10){
    print(num)
    print("This element of the vector is greater then 10.")
  }
}
...
# Element-wise multiplication (Some algorithms works with this type of matrix multiplication)
mat3 <- mat1 * mat2 
mat3
...
names(df) <- c('numbers')
df
# I could use 'colnames' and 'rownames' too. Only 'names' is to rename columns
